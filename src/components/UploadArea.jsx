      ...
      <div className="container mx-auto px-8 max-w-5xl relative z-10">
        ...
        <div className="mb-20 text-center">
          <motion.h2
            ...
            className="text-4xl md:text-6xl lg:text-8xl font-black font-cairo text-primary-dark dark:text-white leading-normal tracking-tight"
          >
            حول جهازك إلى{" "}
            <span className="text-accent-mustard italic">طبيب</span>
            <br /> زراعي ذكي.
          </motion.h2>
        </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h2 className="text-2xl md:text-3xl font-black text-primary-dark dark:text-white font-cairo">
                      أرفع الصورة{" "}
                      <span className="text-accent-mustard italic">هنا</span>
                    </h2>
                  ...
                  <div className="pt-4 flex flex-col items-center gap-4">
                    <div className="flex items-center gap-4 w-full max-w-xs">
                      ...
                      <span className="text-[10px] font-bold text-primary-dark/20 dark:text-white/20 uppercase tracking-widest">
                        أو
                      </span>
                      <div className="h-px flex-1 bg-primary-dark/10 dark:bg-white/10" />
                    </div>
                    ...
                    >
                      ...
                      <span className="font-cairo font-bold text-primary-dark dark:text-white">
                        افتح الكاميرا للتصوير
                      </span>
                    </button>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <div className="text-right flex-1">
                      <h3 className="text-xl md:text-2xl font-black text-white dark:text-white font-cairo mb-1">
                        جاهز للتحليل
                      </h3>
                      <p className="text-base text-white/50 dark:text-white/40 font-cairo font-medium">
                        نظام التشخيص الذكي بانتظار إشارتك
                      </p>
                    </div>
                    <button
