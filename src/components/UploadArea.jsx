...
const LoadingStateTimerAndCarousel = () => {
  ...
  return (
    <motion.div 
      ...
      className="grid md:grid-cols-12 gap-8 items-center p-8 md:p-12 rounded-[2.5rem] bg-white/40 dark:bg-white/[0.02] border border-primary-dark/10 dark:border-white/10 backdrop-blur-xl shadow-precise-luxury w-full"
    >
      {/* Visual Timer Column */}
      <div className="md:col-span-5 flex flex-col items-center justify-center md:border-l border-primary-dark/5 dark:border-white/5 pb-8 md:pb-0 md:pl-8 w-full">
      ...
      {/* Info & Quotes Column */}
      <div className="md:col-span-7 flex flex-col justify-center space-y-6 text-center md:text-right w-full">
        {/* Dynamic Status Title */}
        <div className="space-y-2">
          <h4 className="text-lg md:text-xl font-black text-primary-dark dark:text-white font-cairo">
            جاري تشخيص الصور...
          </h4>
          <div className="flex justify-center md:justify-start items-center gap-2 text-xs md:text-sm text-accent-mustard font-cairo font-bold">
            <span className="w-2.5 h-2.5 rounded-full bg-accent-mustard animate-ping" />
            <span>
        ...
        {/* Quote Carousel */}
        <div className="border-t border-primary-dark/5 dark:border-white/5 pt-5 space-y-2">
          ...
          <div className="min-h-[60px] flex items-center justify-center md:justify-start">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="text-xs sm:text-sm md:text-base text-primary-dark/70 dark:text-white/70 font-cairo font-semibold leading-relaxed"
              >
  ...
  return (
    <section ref={ref} className="w-full py-8 md:py-14 relative overflow-hidden" aria-label="منطقة رفع الصور">
      ...
      <div className="container mx-auto px-4 sm:px-8 max-w-5xl relative z-10">
        ...
        <AnimatePresence mode="wait">
          {loading ? (
            <div key="loading-state" className="max-w-4xl mx-auto w-full">
              <LoadingStateTimerAndCarousel />
            </div>
          ) : (
            <motion.div 
              key="upload-state"
            ...
            >
              <div 
                ...
                onDrop={handleDrop}
                className={`relative rounded-[2.5rem] border-2 border-dashed transition-all duration-700 min-h-[350px] flex flex-col items-center justify-center p-8 md:p-10 overflow-hidden ${
                  previews.length > 0 
