...
const PrivacyPolicyPage = () => {
  return (
    <div className="pt-32 pb-24 px-8 min-h-screen relative overflow-hidden flex flex-col items-center">
      {/* Background elements */}
      <div className="absolute top-40 left-20 w-[400px] h-[400px] bg-primary-dark/5 dark:bg-white/5 blur-[120px] rounded-full pointer-events-none" aria-hidden="true" />
      <div className="absolute bottom-20 right-20 w-[300px] h-[300px] bg-accent-mustard/5 dark:bg-accent-mustard/10 blur-[100px] rounded-full pointer-events-none" aria-hidden="true" />
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-primary-dark/80 dark:text-white/80 font-cairo leading-relaxed">
                مهمتنا هي التحليل وليس التخزين. الصور التي ترفعها تُستخدم فقط لتقديم التشخيص اللحظي، ولا يتم ربطها بأي هوية شخصية أو بيانات خاصة، مما يحافظ على سرية عملك وخصوصية أرضك.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-primary-dark/80 dark:text-white/80 font-cairo leading-relaxed">
                نعتمد بروتوكولات تشفير عالمية لمعالجة الصور لحظياً، دون أن نترك لها أثراً في خوادمنا. بياناتك تمر بسلاسة من هاتفك إلى محرك التحليل وتختفي فوراً بعد انتهاء المهمة.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-primary-dark/80 dark:text-white/80 font-cairo leading-relaxed">
                المعلومات المستخرجة أو النتائج التشخيصية المقدمة تستخدم حصرياً لتحسين تجربتك ومساعدتك في رعاية نباتاتك بشكل أفضل. لا نقوم أبداً ببيع أية بيانات، أو مشاركتها لأغراض تسويقية تجارية مع جهات خارجية. خصوصيتك هي أولوية.
              </p>
            </div>
          </motion.div>
        </div>
