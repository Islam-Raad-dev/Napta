  ...
  const faqs = [
    {
      ...
      answer: "تم تصميم المنصة باستخدام أحدث واجهات البرمجة التفاعلية لضمان تجربة مستخدم سلسلة وراقية، مع التركيز على الانسيابية في الحركة والجمال في التصميم."
    },
    {
      icon: <HelpCircle className="w-5 h-5" />,
      question: "التقنيات المستخدمة في البناء؟",
      answer: "نعتمد على تقنيات معالجة الصور المتقدمة وتكامل عميق مع أقوى محركات الذكاء الاصطناعي من Google، لضمان دقة تحليلية تليق باحتياجات مزارعنا."
    },
    {
      icon: <MessageSquare className="w-5 h-5" />,
      question: "كيفية رفع واستخدام المنصة؟",
      answer: "بساطة التصميم هي سرّنا. كل ما عليك هو التوجه للقسم الرئيسي، رفع صورة واضحة لنباتك، وسيتولى نظامنا الذكي تحليلها وتقديم النتائج والخطط العلاجية في غضون ثوانٍ."
    },
    {
      icon: <Shield className="w-5 h-5" />,
      question: "هل بياناتي وصوري آمنة؟",
      answer: "نعم تماماً. نحن في نبتة نضع أمان البيانات في المقام الأول. لا يتم حفظ صورك الشخصية لأي أغراض تجارية، ونستخدم بروتوكولات تشفير متقدمة لحماية خصوصية كل مزارع يستخدم منصتنا."
    }
  ];
